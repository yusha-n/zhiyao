        ...
        if userphone and password:
            ...
            try:
                ...
                if user.password==password:
                    ...
                    print('login success')
                    return render(request,'login.html',{"incu":incu})
                else:
                    message='密码错误'
...
def incubatorDeatil(request,incubatorno):
    ...
    dir = "F:\\swlab\\bs\\zhiyao-master\\realtime_images"
...
def plantinf_old(request):
    return render(request,'plantinf_old.html')

def howtoplant(request):
    return render(request, 'howtoplant.html')

def showplant(request):
    return render(request, 'showplant.html')
