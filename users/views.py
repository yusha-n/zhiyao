...
class LoginView(View):
    def get(self,request):
        ...
        return render(request,"iotSystem/login.html",{})
    def post(self,request):
        ...
        if login_form.is_valid:
            ...
            if user is not None:
                ...
                return render(request,"iotSystem/login.html",{"msg":u"用户名或密码错误！"})
        else:
            return render(request,"iotSystem/login.html",{"login_form":login_form})
